...
slug: main/pepr-tutorials/create-pepr-module
---
...
3. **Create your custom Pepr Capabilities**
   ...
   *Note: if you also delete the `capabilities/hello-pepr.ts` file, it will be added again on the next [`npx pepr update`](../../user-guide/pepr-cli#pepr-update) so you have the latest examples usages from the Pepr SDK. Therefore, it is sufficient to remove the entry from your `pepr.ts` module
   config.*
